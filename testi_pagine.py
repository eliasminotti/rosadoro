...
<li><strong>Perché siamo una fondazione piccola, con una struttura leggera</strong>: la parte di ciò che doni che serve a farla funzionare è contenuta, e il bilancio — depositato ogni anno al Registro del Terzo settore, e quindi pubblico — lo mostra.</li>
